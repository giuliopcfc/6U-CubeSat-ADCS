...
; } B_Copy_of_detumbling_T ; typedef struct { real_T NextOutput [ 3 ] ;
real_T NextOutput_o [ 3 ] ; real_T NextOutput_a [ 3 ] ; struct { real_T
...
DW_Copy_of_detumbling_T ; typedef struct { real_T Integrator_CSTATE ; real_T
Integrator_CSTATE_d [ 9 ] ; real_T Integrator_CSTATE_l [ 6 ] ; real_T
Integrator_CSTATE_k ; real_T Integrator_CSTATE_g [ 3 ] ; real_T
Integrator_CSTATE_f [ 3 ] ; } X_Copy_of_detumbling_T ; typedef struct {
...
XDot_Copy_of_detumbling_T ; typedef struct { boolean_T Integrator_CSTATE ;
boolean_T Integrator_CSTATE_d [ 9 ] ; boolean_T Integrator_CSTATE_l [ 6 ] ;
boolean_T Integrator_CSTATE_k ; boolean_T Integrator_CSTATE_g [ 3 ] ;
boolean_T Integrator_CSTATE_f [ 3 ] ; } XDis_Copy_of_detumbling_T ; typedef
struct { real_T Integrator_CSTATE ; real_T Integrator_CSTATE_d [ 9 ] ; real_T
Integrator_CSTATE_l [ 6 ] ; real_T Integrator_CSTATE_k ; real_T
Integrator_CSTATE_g [ 3 ] ; real_T Integrator_CSTATE_f [ 3 ] ; }
CStateAbsTol_Copy_of_detumbling_T ; typedef struct { real_T Integrator_CSTATE
; real_T Integrator_CSTATE_d [ 9 ] ; real_T Integrator_CSTATE_l [ 6 ] ;
real_T Integrator_CSTATE_k ; real_T Integrator_CSTATE_g [ 3 ] ; real_T
Integrator_CSTATE_f [ 3 ] ; } CXPtMin_Copy_of_detumbling_T ; typedef struct {
real_T Integrator_CSTATE ; real_T Integrator_CSTATE_d [ 9 ] ; real_T
Integrator_CSTATE_l [ 6 ] ; real_T Integrator_CSTATE_k ; real_T
Integrator_CSTATE_g [ 3 ] ; real_T Integrator_CSTATE_f [ 3 ] ; }
CXPtMax_Copy_of_detumbling_T ; struct P_Copy_of_detumbling_T_ { real_T P_0 ;
real_T P_1 [ 9 ] ; real_T P_2 ; real_T P_3 [ 3 ] ; real_T P_4 [ 3 ] ; real_T
P_5 [ 9 ] ; real_T P_6 ; real_T P_7 [ 3 ] ; real_T P_8 [ 6 ] ; real_T P_9 ;
real_T P_10 [ 3 ] ; real_T P_11 ; real_T P_12 [ 3 ] ; real_T P_13 [ 3 ] ;
real_T P_14 [ 3 ] ; real_T P_15 ; real_T P_16 [ 3 ] ; real_T P_17 [ 3 ] ;
real_T P_18 [ 3 ] ; real_T P_19 ; real_T P_20 ; real_T P_21 ; real_T P_22 ;
real_T P_23 ; real_T P_24 [ 3 ] ; real_T P_25 ; real_T P_26 [ 3 ] ; real_T
P_27 [ 9 ] ; real_T P_28 [ 3 ] ; real_T P_29 ; real_T P_30 ; real_T P_31 [ 14
] ; real_T P_32 [ 14 ] ; real_T P_33 [ 42 ] ; real_T P_34 [ 42 ] ; real_T
P_35 [ 14 ] ; real_T P_36 [ 42 ] ; real_T P_37 [ 42 ] ; real_T P_38 [ 14 ] ;
real_T P_39 ; real_T P_40 ; real_T P_41 ; real_T P_42 ; real_T P_43 ; real_T
P_44 [ 9 ] ; real_T P_45 [ 9 ] ; real_T P_46 ; real_T P_47 ; } ; extern
P_Copy_of_detumbling_T Copy_of_detumbling_rtDefaultP ;
#endif
