...
SimStruct * S , int_T tid ) { B_Copy_of_detumbling_T * _rtB ;
DW_Copy_of_detumbling_T * _rtDW ; P_Copy_of_detumbling_T * _rtP ;
X_Copy_of_detumbling_T * _rtX ; int32_T isHit ; _rtDW = ( (
DW_Copy_of_detumbling_T * ) ssGetRootDWork ( S ) ) ; _rtX = ( (
...
Integrator_CSTATE ; ssCallAccelRunBlock ( S , 10 , 0 , SS_CALL_MDL_OUTPUTS )
; memcpy ( & _rtB -> B_15_4_0 [ 0 ] , & _rtX -> Integrator_CSTATE_d [ 0 ] ,
9U * sizeof ( real_T ) ) ; ssCallAccelRunBlock ( S , 3 , 0 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 4 , 0 , SS_CALL_MDL_OUTPUTS
...
real_T tMinusDelay ; { int_T i1 ; real_T * y0 = & _rtB -> B_15_7_0 [ 0 ] ;
const real_T * p_P_3 = _rtP -> P_3 ; int_T * iw_Tail = & _rtDW ->
...
iw_Head [ i1 ] , p_P_3 [ i1 ] , 0 , ( boolean_T ) ( ssIsMinorTimeStep ( S )
&& ( ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) ) ) ; tBuffer ++ ; uBuffer
++ ; } } } _rtB -> B_15_8_0 [ 0 ] = _rtB -> B_4_0_2 [ 0 ] - _rtB -> B_15_7_0
[ 0 ] ; _rtB -> B_15_9_0 [ 0 ] = _rtX -> Integrator_CSTATE_g [ 0 ] ; _rtB ->
B_15_8_0 [ 1 ] = _rtB -> B_4_0_2 [ 1 ] - _rtB -> B_15_7_0 [ 1 ] ; _rtB ->
B_15_9_0 [ 1 ] = _rtX -> Integrator_CSTATE_g [ 1 ] ; _rtB -> B_15_8_0 [ 2 ] =
_rtB -> B_4_0_2 [ 2 ] - _rtB -> B_15_7_0 [ 2 ] ; _rtB -> B_15_9_0 [ 2 ] =
_rtX -> Integrator_CSTATE_g [ 2 ] ; _rtB -> B_15_10_0 = _rtX ->
Integrator_CSTATE_k ; ssCallAccelRunBlock ( S , 1 , 0 , SS_CALL_MDL_OUTPUTS )
; ssCallAccelRunBlock ( S , 15 , 12 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 0 , 0 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock
( S , 15 , 14 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 14 , 0 ,
SS_CALL_MDL_OUTPUTS ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( ( isHit !=
0 ) && _rtB -> B_14_0_1 ) { ssSetStopRequested ( S , 1 ) ; }
ssCallAccelRunBlock ( S , 15 , 17 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 15 , 18 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 15 , 19 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 11 , 0 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 5 , 0 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock
( S , 7 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_15_23_0 = ssGetT ( S ) ;
ssCallAccelRunBlock ( S , 8 , 0 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock
( S , 6 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_15_26_0 [ 0 ] = ( _rtB ->
B_5_0_1 [ 0 ] + _rtB -> B_7_0_1 [ 0 ] ) + _rtB -> B_6_0_1 [ 0 ] ; _rtB ->
B_15_27_0 [ 0 ] = _rtB -> B_15_26_0 [ 0 ] + _rtB -> B_0_0_1 [ 0 ] ; _rtB ->
B_15_26_0 [ 1 ] = ( _rtB -> B_5_0_1 [ 1 ] + _rtB -> B_7_0_1 [ 1 ] ) + _rtB ->
B_6_0_1 [ 1 ] ; _rtB -> B_15_27_0 [ 1 ] = _rtB -> B_15_26_0 [ 1 ] + _rtB ->
B_0_0_1 [ 1 ] ; _rtB -> B_15_26_0 [ 2 ] = ( _rtB -> B_5_0_1 [ 2 ] + _rtB ->
B_7_0_1 [ 2 ] ) + _rtB -> B_6_0_1 [ 2 ] ; _rtB -> B_15_27_0 [ 2 ] = _rtB ->
B_15_26_0 [ 2 ] + _rtB -> B_0_0_1 [ 2 ] ; ssCallAccelRunBlock ( S , 15 , 28 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 15 , 29 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 15 , 30 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 15 , 31 ,
...
( S , 12 , 0 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 13 , 0 ,
SS_CALL_MDL_OUTPUTS ) ; UNUSED_PARAMETER ( tid ) ; } static void
mdlOutputsTID2 ( SimStruct * S , int_T tid ) { B_Copy_of_detumbling_T * _rtB
; P_Copy_of_detumbling_T * _rtP ; _rtP = ( ( P_Copy_of_detumbling_T * )
ssGetModelRtp ( S ) ) ; _rtB = ( ( B_Copy_of_detumbling_T * )
_ssGetModelBlockIO ( S ) ) ; _rtB -> B_15_2_0_c = _rtP -> P_7 ; _rtB ->
B_15_3_0 = _rtP -> P_8 ; _rtB -> B_15_4_0_k = _rtP -> P_9 ; _rtB -> B_15_5_0
= _rtP -> P_10 ; _rtB -> B_15_6_0 = _rtP -> P_11 ; _rtB -> B_15_8_0_b = _rtP
-> P_13 ; _rtB -> B_15_0_0_m [ 0 ] = _rtP -> P_6 [ 0 ] ; _rtB -> B_15_7_0_c [
0 ] = _rtP -> P_12 [ 0 ] ; _rtB -> B_15_9_0_p [ 0 ] = _rtP -> P_14 [ 0 ] ;
_rtB -> B_15_0_0_m [ 1 ] = _rtP -> P_6 [ 1 ] ; _rtB -> B_15_7_0_c [ 1 ] =
_rtP -> P_12 [ 1 ] ; _rtB -> B_15_9_0_p [ 1 ] = _rtP -> P_14 [ 1 ] ; _rtB ->
B_15_0_0_m [ 2 ] = _rtP -> P_6 [ 2 ] ; _rtB -> B_15_7_0_c [ 2 ] = _rtP ->
P_12 [ 2 ] ; _rtB -> B_15_9_0_p [ 2 ] = _rtP -> P_14 [ 2 ] ; memcpy ( & _rtB
-> B_15_11_0 [ 0 ] , & _rtP -> P_15 [ 0 ] , 9U * sizeof ( real_T ) ) ; _rtB
-> B_15_12_0 [ 0 ] = _rtP -> P_16 [ 0 ] ; _rtB -> B_15_12_0 [ 1 ] = _rtP ->
P_16 [ 1 ] ; _rtB -> B_15_12_0 [ 2 ] = _rtP -> P_16 [ 2 ] ; memcpy ( & _rtB
-> B_15_13_0 [ 0 ] , & _rtP -> P_17 [ 0 ] , 14U * sizeof ( real_T ) ) ;
memcpy ( & _rtB -> B_15_14_0 [ 0 ] , & _rtP -> P_18 [ 0 ] , 14U * sizeof (
real_T ) ) ; memcpy ( & _rtB -> B_15_15_0 [ 0 ] , & _rtP -> P_19 [ 0 ] , 42U
* sizeof ( real_T ) ) ; memcpy ( & _rtB -> B_15_16_0 [ 0 ] , & _rtP -> P_20 [
0 ] , 42U * sizeof ( real_T ) ) ; memcpy ( & _rtB -> B_15_17_0 [ 0 ] , & _rtP
-> P_21 [ 0 ] , 14U * sizeof ( real_T ) ) ; _rtB -> B_15_21_0 = _rtP -> P_22
; _rtB -> B_15_22_0 = _rtP -> P_23 ; _rtB -> B_15_23_0_c = _rtP -> P_24 ;
_rtB -> B_15_24_0 = _rtP -> P_25 ; _rtB -> B_15_25_0 = _rtP -> P_26 ; memcpy
( & _rtB -> B_15_28_0 [ 0 ] , & _rtP -> P_27 [ 0 ] , 9U * sizeof ( real_T ) )
...
_rtDW = ( ( DW_Copy_of_detumbling_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_Copy_of_detumbling_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_Copy_of_detumbling_T * ) _ssGetModelBlockIO ( S ) ) ; { real_T * * uBuffer
...
0 ] , & _rtDW -> TransportDelay_IWORK . Last [ 0 ] , simTime - _rtP -> P_2 ,
...
TransportDelay_IWORK . Head [ 0 ] ] = _rtB -> B_4_0_2 [ 0 ] ; _rtDW ->
...
1 ] , & _rtDW -> TransportDelay_IWORK . Last [ 1 ] , simTime - _rtP -> P_2 ,
tBuffer , uBuffer , ( NULL ) , ( boolean_T ) 0 , false , & _rtDW ->
TransportDelay_IWORK . MaxNewBufSize ) ) { ssSetErrorStatus ( S ,
"tdelay memory allocation error" ) ; return ; } } ( * tBuffer ++ ) [ _rtDW ->
TransportDelay_IWORK . Head [ 1 ] ] = simTime ; ( * uBuffer ++ ) [ _rtDW ->
TransportDelay_IWORK . Head [ 1 ] ] = _rtB -> B_4_0_2 [ 1 ] ; _rtDW ->
...
2 ] , & _rtDW -> TransportDelay_IWORK . Last [ 2 ] , simTime - _rtP -> P_2 ,
tBuffer , uBuffer , ( NULL ) , ( boolean_T ) 0 , false , & _rtDW ->
TransportDelay_IWORK . MaxNewBufSize ) ) { ssSetErrorStatus ( S ,
"tdelay memory allocation error" ) ; return ; } } ( * tBuffer ) [ _rtDW ->
TransportDelay_IWORK . Head [ 2 ] ] = simTime ; ( * uBuffer ) [ _rtDW ->
TransportDelay_IWORK . Head [ 2 ] ] = _rtB -> B_4_0_2 [ 2 ] ; }
UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
...
Integrator_CSTATE_k = _rtB -> B_1_0_2 ; } static void mdlInitializeSizes (
SimStruct * S ) { ssSetChecksumVal ( S , 0 , 3612400642U ) ; ssSetChecksumVal
( S , 1 , 2443027380U ) ; ssSetChecksumVal ( S , 2 , 1313513405U ) ;
ssSetChecksumVal ( S , 3 , 444713532U ) ; { mxArray * slVerStructMat = NULL ;
...
DW_Copy_of_detumbling_T ) ) { ssSetErrorStatus ( S ,
