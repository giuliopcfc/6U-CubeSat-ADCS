#include <math.h>
#include "detumbling_acc.h"
#include "detumbling_acc_private.h"
#include "simstruc.h"
...
#endif
boolean_T detumbling_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T * bufSzPtr ,
...
return ( true ) ; } real_T detumbling_acc_rt_TDelayInterpolate ( real_T
...
= simTime - tMinusDelay ; y0 [ i1 ] = detumbling_acc_rt_TDelayInterpolate (
...
+ _rtP -> P_2 ; _rtDW -> NextOutput [ 2 ] = rt_nrand_Upu32_Yd_f_pw_snf ( &
_rtDW -> RandSeed [ 2 ] ) * _rtP -> P_3 [ 2 ] + _rtP -> P_2 ; } { real_T * *
...
] ) { if ( ! detumbling_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
P_detumbling_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & detumbling_rtDefaultP ) ; rt_InitInfAndNaN ( sizeof ( real_T ) ) ; }
